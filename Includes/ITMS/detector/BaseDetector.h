#pragma once
#ifndef ITMS_BASEDETECTOR_H
#define ITMS_BASEDETECTOR_H
...
/// \return
///
BaseDetector* CreateDetector(itms::tracking::Detectors detectorType, const config_t& config, bool collectPoints, cv::UMat& gray);

#endif // !ITMS_BASEDETECTOR_H